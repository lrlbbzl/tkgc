...
class RecurrentRGCN(nn.Module):
    def __init__(self, decoder_name, encoder_name, num_ents, num_rels, h_dim, opn, num_bases=-1, num_basis=-1,
                 num_hidden_layers=1, dropout=0, self_loop=False, skip_connect=False, layer_norm=False, input_dropout=0,
                 hidden_dropout=0, feat_dropout=0, 
        ...
        self.relation_cell_1 = nn.GRUCell(self.h_dim*2, self.h_dim).to(self.device)
    ...
    def forward(self, g_list, use_cuda):
        ...
        for i, g in enumerate(g_list):
            ...
            if i == 0:
                ...
                x_input = torch.cat((self.emb_rel, x_input), dim=1).to(self.device)
